(function(root, factory) {
    ...
    if (typeof define === "function" && define.amd) {
        define(['moment', 'jquery'], function(moment, $) {
            root.Calendar = factory(moment, $);
            return root.Calendar;
        });
    } else if (typeof module === "object" && module.exports) {
        root.Calendar = factory(require('moment'), require('jquery'));
        module.exports = root.Calendar;
    } else {
        root.Calendar = factory(root.moment, root.jQuery);
    }
    ...
    return function() {
        ...
        var removeClass = function(element, classToRemove) {
            ...
            for (i = 0; i < classValues.length; i = i + 1) {
        ...
        var render = function(isMenus) {
            ...
            for (i = 0; i < options.months; i = i + 1) {
                monthDate = moment(shownFirstMonthDate).startOf('month');
                monthDate = monthDate.add(i, 'months');
                monthTable = renderMonth(monthDate, isMenus);
            ...
            for (i = 0; i < container.children.length; i = i + 1) {
